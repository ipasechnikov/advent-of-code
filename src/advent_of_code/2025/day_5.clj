...
(comment
  ...
  (part-1 "input/2025/day-5.example.txt")
  ;;=> 3

  (part-2 "input/2025/day-5.example.txt")
  ;;=> 14
...
(comment
  ...
  (part-1 "input/2025/day-5.txt")
  ;;=> 735

  (part-2 "input/2025/day-5.txt")
  ;;=> 344306344403172
